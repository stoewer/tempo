...
func (b *backendBlock) Fetch(ctx context.Context, req traceql.FetchSpansRequest, opts common.SearchOptions) (traceql.FetchSpansResponse, error) {
	...
	iter, err := fetch(ctx, req, pf, rgs, b.meta.DedicatedColumns, b.rowNumbers)
	if err != nil {
...
func createAllIterator(ctx context.Context, primaryIter parquetquery.Iterator, conditions []traceql.Condition, allConditions bool, start, end uint64, rgs []parquet.RowGroup, pf *parquet.File, dc backend.DedicatedColumns, selectAll bool, rn *rowNumberIterator) (parquetquery.Iterator, error) {
	...
	resourceIter, err := createResourceIterator(makeIter, instrumentationIter, catConditions.resource, batchRequireAtLeastOneMatchOverall, allConditions, dc, selectAll, rn)
	if err != nil {
